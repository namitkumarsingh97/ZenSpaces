...
>
  <DialogHeader className="relative m-0 block">
    <Typography
      ...
      color="blue-gray"
    >
      Get Your Personalised<br/> Vedic Numerology Report
    </Typography>
    <Typography className="mt-1 font-jost font-normal text-gray-600 text-sm md:text-base lg:text-lg">
      Unlock key insights into your personality, relationships, and future with
      a personalized Vedic Numerology report. Discover your unique path and
      gain tailored guidance to navigate life&apos;s journey with clarity.
    </Typography>
    <IconButton
      size="sm"
      variant="text"
