    ...
    <div className="w-full bg-contain bg-[url('/contactbg2.jpg')]">
      <section className="2xl:py-20 py-10 w-full 2xl:max-w-[80%] max-w-[90%] mx-auto">
        <div className="text-center mx-auto">
          <Typography
            color="white"
            className="mb-4 font-manrope italic text-lg md:text-xl lg:text-2xl"
          >
            Customer Care
          </Typography>
          <Typography
            variant="h1"
            color="white"
            className="mb-4 font-manrope text-4xl md:text-5xl lg:text-6xl"
          >
            We&apos;re Here to Help
          </Typography>
          <Typography className="mb-10 font-manrope italic !text-base lg:mb-20 mx-auto max-w-3xl text-white">
          ...
          <div className="flex flex-col lg:flex-row gap-10 justify-center">
            <iframe
              className="rounded-2xl 2xl:w-[50%] 2xl:h-auto w-full"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3501.5878195930504!2d77.06416777601677!3d28.6421130836445!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d1beab24db74d%3A0x1e149849ad4fec6c!2sZenSpaces!5e0!3m2!1sen!2sin!4v1734423596771!5m2!1sen!2sin"
            ></iframe>
            <form
