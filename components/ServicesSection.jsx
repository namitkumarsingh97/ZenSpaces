    ...
    >
      <div className="2xl:p-2 w-full 2xl:max-w-[80vw] max-w-[90vw] 2xl:h-[75vh] min-h-[75vh] mx-auto flex gap-10 flex-col lg:flex-row 2xl:gap-10">
        ...
        <div className="2xl:w-[60%] w-full lg:mt-10 justify-center items-center 2xl:items-start flex flex-col">
          <Typography
            className="font-ibarra 2xl:text-xl text-base italic md:text-lg"
            variant="h1"
          >
            Unlock The Secrets Of Your Future
          </Typography>
          <Typography
            className="font-ibarra md:text-5xl text-4xl mt-0"
            variant="h1"
          >
            Astrology Courses
          </Typography>
          <div className="lg:w-[70%] text-center 2xl:text-start w-full">
            <Typography className="font-jost font-normal 2xl:text-lg">
          ...
          <Button className="font-jost rounded-sm bg-opacity-60 border-dotted border border-white hover:scale-110 hover:bg-opacity-100 transform transition duration-500 bg-[#AF8C3E] capitalize font-medium text-sm  hover:rounded-none lg:max-w-[50%] 2xl:max-w-[30%] w-[80%]" onClick={()=>{router.push("/courses")}}>
            Read Into The Stars
          </Button>
        </div>
      </div>
      <div className="2xl:p-2 w-full  md:mt-[0%]  2xl:max-w-[80vw] max-w-[90vw] 2xl:h-[75vh] min-h-[75vh] gap-10 mx-auto flex flex-col-reverse lg:flex-row 2xl:gap-10">
        <div className="2xl:w-[60%] w-full mt-0 lg:mt-10 flex items-center 2xl:items-end justify-center flex-col gap-2">
          ...
          <Typography
            className="font-ibarra md:text-5xl text-4xl text-center 2xl:text-start mt-0"
            variant="h1"
          >
            Astrology Products
          </Typography>
          <div className="lg:w-[70%] w-full">
            <Typography className="font-jost font-normal 2xl:text-lg text-center text-base 2xl:text-end">
          ...
          <Button className="font-jost rounded-sm lg:max-w-[50%] bg-opacity-60 border-dotted border border-white hover:scale-110 hover:bg-opacity-100 transform transition duration-500 bg-[#AF8C3E] capitalize font-medium text-sm 2xl:max-w-[30%] w-[80%]" onClick={()=>{router.push("/products")}}>
      ...
      <div className="2xl:p-2 w-full 2xl:max-w-[80vw] max-w-[90vw] 2xl:h-[75vh] min-h-[75vh] mx-auto flex gap-10 lg:flex-row flex-col 2xl:gap-10">
        ...
        <div className="2xl:w-[60%] w-full lg:mt-10 flex mb-10 justify-center 2xl:items-start items-center flex-col gap-2">
          <Typography
            className="font-ibarra text-center 2xl:text-start 2xl:text-xl text-base md:text-lg italic"
            variant="h1"
          >
            Get To Know About What Future Beholds Through
          </Typography>
          <Typography
            className="font-ibarra text-center 2xl:text-start text-4xl md:text-5xl mt-0"
            variant="h1"
          >
            Kundli Readings
          </Typography>
          <div className="lg:w-[70%] w-full">
            <Typography className="font-jost font-normal text-center 2xl:text-start text-base 2xl:text-lg">
          ...
          <Button className="font-jost rounded-sm lg:max-w-[50%] bg-opacity-60 border-dotted border border-white hover:scale-110 hover:bg-opacity-100 transform transition duration-500 bg-[#AF8C3E] capitalize font-medium text-sm 2xl:max-w-[30%] w-[80%]" onClick={()=>{router.push("/readings")}}>
            Unlock Your Future
          </Button>
        </div>
      </div>
