    ...
    <footer className="relative bg-[url('/ff.jpg')] bg-cover bg-center bg-black xl:pb-10 xl:pt-24 pt-10 w-full">
      <div className="mx-auto w-full max-w-[90%] md:max-w-[80%]">
            ...
            {LINKS.map(({ title, items }) => (
              <ul key={title}>
                <Typography
                  variant="small"
                  color="white"
                  className="mb-3 font-jost xl:text-start text-[#d5a948] drop-shadow-xl font-medium text-xl"
                >
                  {title}
                </Typography>
                <li>
                  {items.map(({ name, href }) => (
                    <Typography
                      ...
                      color="white"
                      key={name}
                      className="py-1.5 font-jost text-lg text-start xl:text-start transition duration-300 hover:scale-105 hover:text-[#d5a948]"
                    >
                      {name}
                    </Typography>
                  ))}
            ...
            <ul className="col-span-2 xl:col-span-1">
              ...
              <li className="flex xl:justify-start items-center gap-3">
                ...
                <Typography
                  ...
                  color="white"
                  className="py-1.5 font-jost text-lg transition duration-300 hover:scale-105 hover:text-[#d5a948]"
                >
                  +91 9810800988
                </Typography>
              </li>
              ...
              <li className="flex xl:justify-start items-center gap-3">
                ...
                <Typography
                  ...
                  color="white"
                  className="py-1.5 font-jost text-start text-lg transition duration-300 hover:scale-105 hover:text-[#d5a948]"
                >
                  PANCHAVATI APARTMENT, Promise Apartment, Block F, Vikaspuri, New Delhi, Delhi, 110075
                </Typography>
              </li>
              <li className="flex xl:justify-start items-center gap-3">
                ...
                <Typography
                  ...
                  onClick={() => handleNavigation("#")} // Use handleNavigation for routing
                  color="white"
                  className="py-1.5 text-start font-jost text-lg transition duration-300 hover:scale-105 hover:text-[#d5a948]"
                >
        ...
        <div className="mt-12 flex w-full items-center justify-between border-t border-blue-gray-50 py-4">
          <Typography
            variant="small"
            className="mb-4 xl:text-center font-jost text-white md:mb-0"
          >
            &copy; {currentYear} <a href="/">Astropathways</a>. All Rights Reserved.
          </Typography>
          <div className="flex gap-4 text-white">
            <Typography as="button" onClick={() => handleNavigation("#")} className="opacity-80 transition duration-300 hover:text-[#d5a948] hover:scale-125 hover:opacity-100">
