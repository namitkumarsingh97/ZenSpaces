          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-5 w-full 2xl:w-[50%]'>
            <div className="bg-black transition hover:border border-opacity-0 hover:border-opacity-50 border hover:shadow-none hover:scale-110 duration-500 shadow-md border-[white] rounded-md flex flex-col gap-1 md:gap-2 lg:gap-3">
              <div className='flex items-center justify-center 2xl:p-5 p-2 flex-col gap-5 2xl:gap-10'>
                ...
                <div className='flex flex-col gap-3 2xl:gap-5 text-center'>
                  <Typography className='font-ibarra 2xl:text-4xl text-2xl'>Phone</Typography>
                  <Typography className='font-jost 2xl:text-lg'>+91 9810800988</Typography>
                </div>
              </div>
            </div>
            ...
            <div className="bg-black transition hover:border border-opacity-0 hover:border-opacity-50 border hover:shadow-none hover:scale-110 duration-500 shadow-md border-[white] rounded-md flex flex-col gap-1 md:gap-2 lg:gap-3">
              <div className='flex items-center justify-center 2xl:p-5 p-2 flex-col gap-5 2xl:gap-10'>
                ...
                <div className='flex flex-col gap-3 2xl:gap-5 text-center'>
                  <Typography className='font-ibarra 2xl:text-4xl text-2xl'>Email</Typography>
                  <Typography className='font-jost 2xl:text-lg'>astrovasturaman@gmail.com</Typography>
                </div>
              </div>
            </div>
            ...
            <div className="bg-black transition hover:border border-opacity-0 hover:border-opacity-50 border hover:shadow-none hover:scale-110 duration-500 shadow-md border-[white] rounded-md flex flex-col gap-1 md:gap-2 lg:gap-3">
              <div className='flex items-center justify-center 2xl:p-5 p-2 flex-col gap-5 2xl:gap-10'>
                ...
                <div className='flex flex-col gap-3 2xl:gap-5 text-center'>
                  <Typography className='font-ibarra 2xl:text-4xl text-2xl'>Address</Typography>
                  <Typography className='font-jost 2xl:text-lg text-center'>PANCHAVATI APARTMENT, Promise Apartment, Block F, Vikaspuri, New Delhi, Delhi, 110075</Typography>
                </div>
              </div>
            </div>
            ...
            <div className="bg-black transition hover:border border-opacity-0 hover:border-opacity-50 border hover:shadow-none hover:scale-110 duration-500 shadow-md border-[white] rounded-md flex flex-col gap-1 md:gap-2 lg:gap-3">
              <div className='flex items-center justify-center 2xl:p-5 p-2 flex-col gap-5 2xl:gap-10'>
                ...
                <div className='flex flex-col gap-3 2xl:gap-5 text-center'>
                  <Typography className='font-ibarra 2xl:text-4xl text-2xl'>Timings</Typography>
                  <Typography className='font-jost 2xl:text-lg'>Mon-Sat 10:00AM to 08:00PM</Typography>
                </div>
              </div>
            </div>
          </div>
  
          <form onSubmit={sendMail} className="flex 2xl:w-[40%] w-full flex-col gap-4 mt-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Typography variant="small" className="mb-2 text-left font-jost font-medium !text-white">First Name</Typography>
                <Input
                  color="white"
                  size="lg"
              ...
              <div>
                <Typography variant="small" className="mb-2 text-left font-medium font-jost !text-white">Last Name</Typography>
                <Input
                  color="white"
                  size="lg"
            ...
            <div>
              <Typography variant="small" className="mb-2 text-left font-medium font-jost !text-white">Your Email</Typography>
              <Input
                color="white"
                size="lg"
            ...
            <div>
              <Typography variant="small" className="mb-2 text-left font-medium font-jost !text-white">Your Message</Typography>
              <Textarea
                placeholder="Message"
                name="message"
                value={message}
            ...
            <Button type="submit" className="w-full font-jost" color="white">Send message</Button>
          </form>
        </div>
      </section>
    </div>
    {/* Uncomment this iframe for Google Maps if needed */}
    {/* <iframe className="w-full h-[60vh]" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3501.5878195930563!2d77.06416777613751!3d28.64211308364433!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d1beab24db74d%3A0x1e149849ad4fec6c!2sAstropathways!5e0!3m2!1sen!2sin!4v1721642963847!5m2!1sen!2sin" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> */}
  </div>
