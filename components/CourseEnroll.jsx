...
//           <Typography className="font-manrope m-0 text-3xl xl:text-4xl">
//             Course Details
//           </Typography>
//           <div className="flex flex-col gap-5 justify-center">
//             <div className="grid grid-cols-2">
//               <Typography className="font-mulish m-0 text-lg">
//                 Course Name :
//               </Typography>
...
//             </div>
//             <div className="grid grid-cols-2">
//               <Typography className="font-mulish m-0 text-lg">Batch</Typography>
//               <Typography className="font-mulish m-0 text-lg font-medium">
//                 {courseData.days}
//               </Typography>
//             </div>
...
//             className="font-mulish md:w-[50%] m-0 lg:w-[30%] w-full rounded-lg border opacity-100 border-white transform transition duration-500 bg-[#AF8C3E] capitalize font-medium text-base"
//           >
//             Proceed
//           </Button>
//         </div>
