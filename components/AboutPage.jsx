    ...
    <div className="w-full">
      ...
      <div className="w-full grid lg:grid-cols-12 grid-cols-1 gap-5 xl:gap-10 lg:gap-5 mx-auto xl:max-w-[80%] max-w-[90%]">
        ...
        <div className="lg:col-span-6 flex lg:pt-24 lg:pb-20 gap-5 justify-center flex-col">
          <Typography className="md:text-xl text-lg italic text-[#AF8C3E] font-ibarra">
            --About Us
          </Typography>
          <Typography className="md:text-5xl text-4xl  font-ibarra">
            Unlocking The Secrets Of Kundli
          </Typography>
          <Typography className="xl:text-lg text-base font-normal font-jost">
            Astropathways is a dedicated platform that aims to provide authentic
            and insightful Kundali readings, high-quality astrology products,
            and transformative astrology courses guided by Astrologer Raman
            Singh who holds expertise in Lal Kitab, Vastu, Astrovastu, prashari
            Jyotish .
          </Typography>
          <Typography className="xl:text-lg text-base font-normal font-jost">
      ...
      <div className="w-full bg-cover">
        <div className="xl:max-w-[80%] max-w-[90%] mx-auto flex flex-col gap-5 xl:gap-10 xl:pb-20 py-5">
          <Typography className="font-ibarra md:text-xl text-lg text-[#AF8C3E] italic">
            --Our Astrologer
          </Typography>
          <div className="flex flex-col lg:flex-row gap-10 items-center">
            ...
            <div className="flex flex-col gap-5">
              <Typography className="font-ibarra mb-0 text-4xl md:text-5xl xl:text-6xl">
                Acharya Raman Singh
              </Typography>
              <Typography className="font-ibarra mt-0 text-xl md:text-2xl italic text-[#AF8C3E]">
                (Lal Kitab & Vastu Expert)
              </Typography>
              <Typography className="font-jost m-0 xl:text-lg text-base font-normal">
      ...
      <div className="w-full bg-cover">
        <div className=" xl:max-w-[80%] max-w-[90%] mx-auto flex flex-col gap-5 xl:gap-10 xl:pb-20 py-5">
          ...
          <Typography className="font-ibarra text-4xl md:text-5xl xl:text-6xl">
            ...
            <div className="bg-black bg-[url('/cardbg2.jpg')] bg-contain transition hover:border border-opacity-0 hover:border-opacity-50 border hover:shadow-none hover:scale-110 duration-500 shadow-md border-[white] rounded-md shadow-[white]  flex flex-col gap-1 md:gap-2 lg:gap-3 aspect-square">
              <div className="flex p-5 flex-col xl:gap-20 gap-10">
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <Typography className="font-jost font-normal text-base xl:text-lg">
