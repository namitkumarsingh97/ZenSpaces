...
//   }, []);
  ...
  return (
    ...
    //           <Typography className="font-ibarra text-center m-0 text-black text-2xl xl:text-3xl 2xl:text-4xl pb-5">
    //             Astropathways - {courseData?.courseTitle || ''}
    //           </Typography>
    //           {ifLogin ? (
    //             <>
    ...
    <div className="relative bg-white bg-[url('/bgenroll.jpg')] bg-cover bg-center flex items-center justify-center min-h-screen overflow-hidden">
      <div className="w-full max-w-2xl mx-auto p-6 transform -translate-y-16">
        <div className="bg-white rounded-xl shadow-2xl p-8">
          <Typography className="font-ibarra text-center text-3xl text-gray-800 mb-6">
            Astropathways - {courseData?.courseTitle || ''}
          </Typography>
          ...
          {/* {ifLogin ? ( */}
            <>
              ...
              {/* <div className="mt-4 text-center">
                <Typography className="font-jost text-gray-600">
                  Don&apos;t have an account?{' '}
                  <span
          ...
          <div className="mt-8 space-y-4">
            <Typography className="font-ibarra text-center text-2xl text-gray-800">
              Course Details
            </Typography>
            <Input
              color="gray"
            ...
            <Button
              ...
              className="w-full font-jost py-2 rounded-lg hover:bg-opacity-90 transition-all"
      ...
      {showForgotPassword && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 w-96">
            <Typography className="font-ibarra text-2xl text-gray-800 mb-4">
              Reset Password
            </Typography>
            <Input
              color="gray"
            ...
            <Button
              variant="filled"
              className="w-full bg-purple-600 hover:bg-purple-700 text-white font-jost py-2 rounded-lg"
              onClick={handleForgotPassword}
            >
              Send Reset Link
            </Button>
            <Button
              variant="text"
              className="w-full text-gray-600 font-jost mt-2"
              onClick={() => setShowForgotPassword(false)}
            >
              Close
            </Button>
